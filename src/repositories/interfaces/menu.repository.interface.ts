...
export interface IMenuRepository {
    ...
    getAllMenuData(restaurantId: string, search?: string, category?: string): Promise<MenuItemInterface[] | { error: string }>;
    ...
    getRestaurantMenus(data: void): Promise<any[]>;
    ...
    checkStockAvailability(data: any): Promise<{ success: boolean, message?: string; error?: string }>
    decrementStock(data: any): Promise<{ success: boolean }>
}